...
def analyze_packets_with_ai(har_filename, mode, streaming, show_think, spinner):
    ...
    system_prompt = (
        ...
        "For each vulnerable request, output exactly one entry (in English) with these fields:\n"
            ...
            "  • test (what value to change and why—e.g. change price to \"0.01\", swap user_id)\n"
            ...
            for chunk in stream_resp:
                ...
                if hasattr(delta, "reasoning_content") and delta.reasoning_content:
                    ...
                    if show_think:
                        ...
                        print(delta.reasoning_content, end="", flush=True) #end="" para no hacer salto de linea y fluush para forzar salida inmediata sin almacenar en buffer
    ...
    try:
        ...
        print(f"{bcolors.FAIL}[ERROR]: Error parsing JSON from AI response{bcolors.ENDC}")
