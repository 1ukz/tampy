...
def analyze_packets_with_ai(har_filename, mode, streaming, show_think, spinner):
    ...
    system_prompt = (
        ...
        "-   Parameter locations: Handle 'url_path', 'query', 'headers', and 'body' consistently. For 'url_path', identify dynamic segments (e.g., '/resource/{id}') and return in the parameter_name the index position starting from 0 of the segment (e.g., /user/{id}/cart, this should be parameter_name:'1'). The parameter_location should be exactly the one that appears, do not make it up.\n\n"
